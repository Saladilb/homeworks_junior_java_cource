...
public class MessageService {
    public static void printQueryMessage() {
        System.out.println("Now let's get average value of elements. Please enter the array elements. When the length of the array is reached, the elements will automatically be filled in to a new row. We will notify you of the end of filling in the form.");
    }
    ...
    public static void startGetResultMessage() {
        System.out.println("Let's get average value of all elements: ");
    }
