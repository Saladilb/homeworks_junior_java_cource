...
public class MessageService {
    public static void printQueryMessage() {
        System.out.println("Now let's get result count local max number of elements. Please enter the array elements. When the length of the array is reached, the elements will automatically be filled in to a new row. We will notify you of the end of filling in the form.");
    }
